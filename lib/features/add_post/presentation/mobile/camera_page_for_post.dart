              ...
              ? Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {},
                    child: ShaderText(
                      textWidget: Text('Retake', style: txtStyleNoColor(18)),
                    ),
                  ),
                  TextButton(
                    onPressed: () {},
                ...
                children: [
                  IconButton(
                    ...
                    icon: const ShaderIcon(
                      iconWidget: Icon(Ionicons.checkmark, size: 40),
                    ),
                  ),
                  IconButton(
                    onPressed: () {
                    ...
                    icon: const ShaderIcon(
                      iconWidget: Icon(Ionicons.trash_bin_outline, size: 40),
                    ),
                  ),
                ],
              ),
